...
#include "drivers/shared/scaling.h"
...
static bool dinput_control_xfer_cb(uint8_t rhport, uint8_t stage, tusb_control_request_t const * request)
{
...
void DInputDriver::initialize() 
{
	...
	class_driver = {
		...
		.reset = hidd_reset,
		.open = hidd_open,
		.control_xfer_cb = dinput_control_xfer_cb,
